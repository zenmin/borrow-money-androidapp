package com.zm.borrowmoneyandriodapp.util.gen;
...
public class CodeGenerator {
    ...
    // 全包名
    static final String packageName = "com.zm.borrowmoneyandriodapp";
    // 数据库url
    static final String jdbcUrl = "jdbc:mysql://localhost:3306/borrowmoney?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8";
    // 数据库用户名
