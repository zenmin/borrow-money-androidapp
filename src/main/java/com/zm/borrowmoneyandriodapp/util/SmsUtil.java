package com.zm.borrowmoneyandriodapp.util;
...
public class SmsUtil {
    ...
    public void sendSms(String phone, Map param) {
        ...
        try {
            ...
            request.setTemplateParam(JSONUtil.toJSONString(param));
            ...
            log.error("短信发送失败！");
            e.printStackTrace();
            throw new CommonException(DefinedCode.PARAMS_ERROR, "短信发送失败，请重试！");
        }
    }
